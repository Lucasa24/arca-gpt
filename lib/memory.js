...
DIRETRIZ SUPREMA DE EXTENSÃO (CRÍTICO):
- O usuário EXIGE profundidade extrema.
- NUNCA dê respostas curtas de 1 ou 2 parágrafos.
- Escreva uma TESE, não um post de blog.
- Mínimo de 600 palavras por resposta.
- Se for curto, você falhou.
