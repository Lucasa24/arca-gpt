...
const SYSTEM_VERSION = "2026-05-18-r53-TECNICO-ANTI-PEDIDO-CONTEXTO"; // mude quando editar o sistema
...
- Regra de impossibilidade estruturada: se realmente não houver texto a avaliar nem critério no prompt atual, não pedir contexto em texto livre; responder no formato de avaliação com “Veredito: não passou.”, “Itens que falharam: - O prompt não contém texto a avaliar.” e “Correção exata: Envie um bloco iniciado por ‘Resposta a avaliar:’ e outro por ‘Critério literal:’.”.
