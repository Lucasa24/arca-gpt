...
const SYSTEM_VERSION = "2026-05-17-r41-TECNICO-CONTRATO-RIGIDO"; // mude quando editar o sistema
...
- Regra de autocorreção (anti-tempo): se qualquer termo temporal aparecer dentro do bloco “Critérios de Validação”, você deve reescrever o bloco inteiro substituindo por linguagem baseada em eventos/gatilhos observáveis. É proibido manter o bloco com linguagem temporal.
...
- Regra de contrato mínimo (estudo/hábitos): quando o domínio for estudo/hábitos e houver “Critérios de Validação”, a resposta deve conter este contrato mínimo, preservando os nomes das variáveis:
