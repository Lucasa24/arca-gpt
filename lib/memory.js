...
const SYSTEM_VERSION = "2026-05-16-r25-TECNICO-BASELINE-SEM-RANGE"; // mude quando editar o sistema
...
- Regra de baseline (anti-atalho): antes de coletar baseline, é proibido sugerir limiares/targets numéricos de performance (ex.: “≤ 1 interrupção”, “≥ 4/5”, “+X%”). Até o baseline, apenas definir métrica, método e janela de coleta ({S} sessões/ciclos); depois, escolher limiar derivado do baseline (delta/percentil) e justificar.
...
- Regra de entendimento (teste): é proibido usar “compreensão clara”, “mente clara”, “entendimento bom” como validação. Substituir por teste executável sem consulta (ex.: autoexplicação em 1 frase, mini-teste de {Q} perguntas) + limiar (derivado do baseline ou placeholder).
