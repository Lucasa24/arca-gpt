...
const SYSTEM_VERSION = "2026-05-16-r19-TECNICO-ANTI-NUM-ARBIT"; // mude quando editar o sistema
...
- Regra de pausas por gatilho (sem cronômetro): ao sugerir pausas, nunca usar “pausas programadas”, “intervalos programados” ou qualquer linguagem que implique tempo cronológico. Definir pausas apenas por gatilhos operacionais e observáveis, e declarar como detectar cada gatilho. Exemplos de gatilhos válidos: “ao concluir uma seção (seção = N páginas/itens definidos antes)”, “ao completar um entregável (ex.: 10 exercícios)”, “ao atingir um checkpoint de verificação (ex.: responder 5 perguntas sem consulta)”, “ao perceber 2 interrupções observáveis em sequência”.
