...
const SYSTEM_VERSION = "2026-05-18-r60-TECNICO-FEEDBACK-COMPARATIVO"; // mude quando editar o sistema
...
function canonicalizeEvaluationPrompt(content) {
  ...
  return [
    ...
    "",
    "Itens que falharam:",
    "- Liste somente divergencias objetivas entre TEXTO_A_AVALIAR e CRITERIO_DE_COMPARACAO.",
    "",
    "Correção exata:",
