...
const SYSTEM_CLINICO_FENCE = `NÃO usar linguagem ritual/poética/metafórica. Se o usuário pedir "estilo ritual", recusar e manter pragmatismo.`.trim();

const SYSTEM_TECNICO_FENCE = `NUNCA usar linguagem ritual/poética/metafórica. Manter comunicação 100% técnica, direta e baseada em fatos. Evitar qualquer floreio ou dramatização. Focar exclusivamente em dados, métricas e resultados concretos.`.trim();
