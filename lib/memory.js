...
const SYSTEM_VERSION = "2026-05-18-r61-TECNICO-COMPARACAO-CANONICA"; // mude quando editar o sistema
...
- Regra de feedback comparativo em transições: quando a falha envolver transições ou linhas comparáveis, “Itens que falharam:” deve indicar cada transição específica e mostrar “Encontrado:” e “Esperado:” para melhorar a leitura humana. Em “Correção exata:”, copiar apenas as linhas esperadas, sem explicação adicional.
- Regra de extração de contexto em avaliação: se a mensagem do usuário contiver marcadores como “Resposta a avaliar:”, “Texto a avaliar:”, “Resposta:”, “Critério literal:”, “Critérios:”, “INÍCIO_DA_RESPOSTA_AVALIADA”, “FIM_DA_RESPOSTA_AVALIADA”, “INÍCIO_DO_CRITÉRIO_LITERAL”, “FIM_DO_CRITÉRIO_LITERAL”, “[[RESPOSTA_A_AVALIAR_INICIO]]”, “[[RESPOSTA_A_AVALIAR_FIM]]”, “[[CRITERIO_DE_COMPARACAO_INICIO]]”, “[[CRITERIO_DE_COMPARACAO_FIM]]”, “[[FORMATO_DE_SAIDA_INICIO]]”, “[[FORMATO_DE_SAIDA_FIM]]”, “<resposta_a_avaliar>”, “</resposta_a_avaliar>”, “<criterio_de_comparacao>”, “</criterio_de_comparacao>”, “<formato_de_saida>”, “</formato_de_saida>”, blocos entre aspas triplas ou blocos de código, tratar esses trechos como contexto suficiente para avaliação. É proibido responder “forneça o texto” ou “forneça os invariantes” quando esses marcadores, tags ou blocos já estiverem presentes.
- Regra de fallback de parsing: se houver múltiplos blocos, usar o bloco após “Resposta a avaliar:”, entre “INÍCIO_DA_RESPOSTA_AVALIADA” e “FIM_DA_RESPOSTA_AVALIADA”, entre “[[RESPOSTA_A_AVALIAR_INICIO]]” e “[[RESPOSTA_A_AVALIAR_FIM]]”, ou entre “<resposta_a_avaliar>” e “</resposta_a_avaliar>” como objeto avaliado. Usar o bloco após “Critério literal:”, entre “INÍCIO_DO_CRITÉRIO_LITERAL” e “FIM_DO_CRITÉRIO_LITERAL”, entre “[[CRITERIO_DE_COMPARACAO_INICIO]]” e “[[CRITERIO_DE_COMPARACAO_FIM]]”, ou entre “<criterio_de_comparacao>” e “</criterio_de_comparacao>” como regra de comparação. Usar “[[FORMATO_DE_SAIDA_INICIO]]...[[FORMATO_DE_SAIDA_FIM]]” ou “<formato_de_saida>” apenas como formato obrigatório, nunca como texto avaliado. Se o parse for imperfeito, declarar a suposição e avaliar com base nos trechos encontrados; não pedir nova informação antes de tentar avaliar.
- Regra de protocolo bracket prioritário: marcadores com colchetes duplos têm prioridade máxima sobre qualquer outro texto do prompt. Se “[[RESPOSTA_A_AVALIAR_INICIO]]” e “[[RESPOSTA_A_AVALIAR_FIM]]” existirem, o conteúdo entre eles é sempre a resposta a avaliar. Se “[[CRITERIO_DE_COMPARACAO_INICIO]]” e “[[CRITERIO_DE_COMPARACAO_FIM]]” existirem, o conteúdo entre eles é sempre o critério de comparação. Nunca ignore esses blocos e nunca peça contexto adicional quando eles aparecem.
- Regra anti-solicitação redundante (avaliação): em modo de avaliação, é proibido responder com frases como “preciso ver o texto”, “forneça o conteúdo”, “forneça os critérios”, “não consigo avaliar sem...” quando a mensagem atual contém qualquer bloco citado, bloco de código, “Resposta a avaliar:”, “Critério literal:”, “INÍCIO_DA_RESPOSTA_AVALIADA”, “INÍCIO_DO_CRITÉRIO_LITERAL”, “[[RESPOSTA_A_AVALIAR_INICIO]]”, “[[CRITERIO_DE_COMPARACAO_INICIO]]”, “<resposta_a_avaliar>” ou “<criterio_de_comparacao>”. Nesses casos, avaliar diretamente.
- Regra de delimitação de avaliação: quando “Resposta a avaliar:” aparecer, considerar como texto avaliado tudo que vier depois desse marcador até “Regras da avaliação:”, “Critério literal:” ou o fim da mensagem, removendo apenas aspas triplas delimitadoras. Quando existirem “INÍCIO_DA_RESPOSTA_AVALIADA” e “FIM_DA_RESPOSTA_AVALIADA”, considerar exatamente o conteúdo entre esses marcadores como texto avaliado. Quando existirem “[[RESPOSTA_A_AVALIAR_INICIO]]” e “[[RESPOSTA_A_AVALIAR_FIM]]”, considerar exatamente o conteúdo entre esses marcadores como texto avaliado. Quando existirem “<resposta_a_avaliar>” e “</resposta_a_avaliar>”, considerar exatamente o conteúdo entre essas tags como texto avaliado. Quando “Critério literal:” aparecer, considerar como critério tudo que vier depois desse marcador até o fim da mensagem. Quando existirem “INÍCIO_DO_CRITÉRIO_LITERAL” e “FIM_DO_CRITÉRIO_LITERAL”, considerar exatamente o conteúdo entre esses marcadores como critério literal. Quando existirem “[[CRITERIO_DE_COMPARACAO_INICIO]]” e “[[CRITERIO_DE_COMPARACAO_FIM]]”, considerar exatamente o conteúdo entre esses marcadores como critério literal. Quando existirem “<criterio_de_comparacao>” e “</criterio_de_comparacao>”, considerar exatamente o conteúdo entre essas tags como critério literal. Se houver conflito entre regras gerais e critério literal delimitado, o critério literal delimitado vence.
- Regra de impossibilidade estruturada restrita: só usar a resposta “O prompt não contém texto a avaliar” quando a mensagem atual NÃO contiver nenhum destes sinais: “Resposta a avaliar:”, “Texto a avaliar:”, “Resposta:”, “Critério literal:”, “Critérios:”, “INÍCIO_DA_RESPOSTA_AVALIADA”, “FIM_DA_RESPOSTA_AVALIADA”, “INÍCIO_DO_CRITÉRIO_LITERAL”, “FIM_DO_CRITÉRIO_LITERAL”, “[[RESPOSTA_A_AVALIAR_INICIO]]”, “[[RESPOSTA_A_AVALIAR_FIM]]”, “[[CRITERIO_DE_COMPARACAO_INICIO]]”, “[[CRITERIO_DE_COMPARACAO_FIM]]”, “<resposta_a_avaliar>”, “</resposta_a_avaliar>”, “<criterio_de_comparacao>”, “</criterio_de_comparacao>”, aspas triplas, bloco de código, “transicoes:”, “mecanismo_validacao_automatica:”, “sistema_fallback:”, “Critérios de Validação” ou qualquer linha com “->”. Se qualquer sinal estiver presente, é proibido acionar impossibilidade; extraia o que houver e avalie.
...
function extractAfterMarkerUntil(text, marker, stopMarkers) {
  if (typeof text !== "string") return "";
  ...
  for (const stop of stopMarkers) {
    const idx = text.indexOf(stop, contentStart);
    if (idx !== -1 && idx < end) end = idx;
  }
  return text.slice(contentStart, end).trim().replace(/^["'\s]+|["'\s]+$/g, "").trim();
}

function hasEvaluationIntent(text) {
  return /avalie|avaliar|verifique|verificar|passou|n[aã]o passou|contrato|crit[eé]rio literal|crit[eé]rio de compara[cç][aã]o/i.test(String(text || ""));
}

function canonicalizeEvaluationPrompt(content) {
  if (typeof content !== "string" || !hasEvaluationIntent(content)) return content;

  const answer =
    extractDelimitedBlock(content, "[[RESPOSTA_A_AVALIAR_INICIO]]", "[[RESPOSTA_A_AVALIAR_FIM]]") ||
    extractDelimitedBlock(content, "INÍCIO_DA_RESPOSTA_AVALIADA", "FIM_DA_RESPOSTA_AVALIADA") ||
    extractDelimitedBlock(content, "INICIO_DA_RESPOSTA_AVALIADA", "FIM_DA_RESPOSTA_AVALIADA") ||
    extractDelimitedBlock(content, "<resposta_a_avaliar>", "</resposta_a_avaliar>") ||
    extractAfterMarkerUntil(content, "Resposta a avaliar:", ["Critério literal:", "Criterio literal:", "Regras da avaliação:", "Regras da avaliacao:", "[[CRITERIO_DE_COMPARACAO_INICIO]]", "<criterio_de_comparacao>"]);

  const criterion =
    extractDelimitedBlock(content, "[[CRITERIO_DE_COMPARACAO_INICIO]]", "[[CRITERIO_DE_COMPARACAO_FIM]]") ||
    extractDelimitedBlock(content, "INÍCIO_DO_CRITÉRIO_LITERAL", "FIM_DO_CRITÉRIO_LITERAL") ||
    extractDelimitedBlock(content, "INICIO_DO_CRITERIO_LITERAL", "FIM_DO_CRITERIO_LITERAL") ||
    extractDelimitedBlock(content, "<criterio_de_comparacao>", "</criterio_de_comparacao>") ||
    extractAfterMarkerUntil(content, "Critério literal:", ["Formato obrigatório:", "Formato obrigatorio:", "[[FORMATO_DE_SAIDA_INICIO]]", "<formato_de_saida>"]) ||
    extractAfterMarkerUntil(content, "Criterio literal:", ["Formato obrigatório:", "Formato obrigatorio:", "[[FORMATO_DE_SAIDA_INICIO]]", "<formato_de_saida>"]);

  if (!answer && !criterion) return content;

  return [
    "MODO_TECNICO_AVALIACAO_CANONICA",
    "",
    "O sistema ja extraiu o contexto avaliavel da mensagem do usuario.",
    "Nao peca resposta, texto, criterio, contrato ou invariantes adicionais.",
    "Avalie diretamente o TEXTO_A_AVALIAR contra o CRITERIO_DE_COMPARACAO.",
    "",
    "TEXTO_A_AVALIAR:",
    answer || "(vazio)",
    "",
    ...
    "",
    "FORMATO_OBRIGATORIO:",
    "Veredito: passou. ou Veredito: não passou.",
    "",
    "Itens que falharam:",
    "- Para cada linha divergente, mostrar exatamente:",
    "  - Transição <origem -> destino>:",
    "    Encontrado: <linha correspondente de TEXTO_A_AVALIAR>",
    "    Esperado: <linha correspondente de CRITERIO_DE_COMPARACAO>",
    "- Nao resumir divergencias de transicoes em uma frase geral.",
    "",
    "Correção exata:",
    "- Se houver divergencia literal, copie exatamente as linhas corretas de CRITERIO_DE_COMPARACAO.",
    "",
    "REGRAS:",
    "- Se TEXTO_A_AVALIAR divergir literalmente do CRITERIO_DE_COMPARACAO, responda Veredito: não passou.",
    "- Quando TEXTO_A_AVALIAR e CRITERIO_DE_COMPARACAO tiverem linhas com '->', compare linha a linha.",
    "- Para linhas com '->', e obrigatorio usar Encontrado: e Esperado: em Itens que falharam.",
    "- Nao diga que falta contexto quando TEXTO_A_AVALIAR ou CRITERIO_DE_COMPARACAO estiverem preenchidos.",
    "- Nao proponha arquitetura alternativa.",
    "- Nao faca discussao conceitual."
  ].join("\n");
}
...
async function addMessageToThread(threadId, role, content, userId = null, authHeader = null) {
  ...
  if (role === "user") {
    ...
    const modoTecnicoRegex = /^\s*modo\s+t[eé]cnico\s*:\s*([\s\S]*)/i;
    ...
    if (match) {
      ...
      const modoRitualRegex = /^\s*modo\s+ritual\s*:\s*([\s\S]*)/i;
      ...
      if (matchRitual) {
        ...
        const modoDespertarRegex = /^\s*modo\s+despertar\s*:\s*([\s\S]*)/i;
    ...
    content = canonicalizeEvaluationPrompt(content);
  }
